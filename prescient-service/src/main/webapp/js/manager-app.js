 ...
 */
var manager_app = angular.module('manager_app', ['ngRoute', 'LocalStorageModule', 'ngDialog','ngTable']);
...
manager_app.controller('guest_list_controller', function ($scope, $http, $routeParams, localStorageService) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/all',
        method: 'get',
        headers: {
...
manager_app.controller('guest_details_controller', function ($scope, $http, $routeParams, localStorageService,$timeout,$route) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/lateststay',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/details',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.viewImage = function (filename, ext) {
        $http({
            url: 'http://192.168.1.10:8080/api/guest/image/' + filename + '/' + ext,
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
...
//added below  27-8-2014
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/photos',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.getGuestImage = function () {
        ...
        var url = 'http://192.168.1.10:8080/api/guest/image/' + $scope.filename + '/' + $scope.ext;
        console.log('URL::::' + url);
    ...
    $scope.attachGuestImage = function (app_form) {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/image/' + $scope.filename + '/' + $scope.ext + '/update',
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
    ...
    $scope.removeGuestImage=function()
    {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/image/remove',
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
...
manager_app.controller('create_guest_controller', function ($scope, $http, $routeParams, localStorageService, $location, ngDialog, sharedProperties) {
    ...
    $scope.OnPassportChange=function()
    {
        ...
        if($scope.guest.passportNumber!=undefined)
        {
            if($scope.guest.passportNumber.trim().length!=0)
            {
                ...
                $http({
                    url: 'http://192.168.1.10:8080/api/guest/passport/' + $scope.guest.passportNumber + '/details',
                    method: 'get',
                    headers: {
                        'Authorization': localStorageService.get("auth")
                    }
    ...
    $scope.OnIdChange=function()
    {
        ...
        if( $scope.guest.idNumber!=undefined)
        {
            if($scope.guest.idNumber.trim().length!=0)
            {
                ...
                $http({
                    url: 'http://192.168.1.10:8080/api/guest/uniqueid/' + $scope.guest.idNumber + '/details',
                    method: 'get',
                    headers: {
                        'Authorization': localStorageService.get("auth")
                    }
    ...
    $scope.create = function (app_form) {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/create',
            method: 'post',
            headers: {
...
manager_app.controller('update_details_controller', function ($scope, localStorageService, $routeParams, $http, $location, ngDialog,sharedProperties) {
    ...
    $scope.update = function (guest_update_form) {
        ...
        $http({
            ...
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/update',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
        ...
        console.log('check passport');
           if($scope.guest_detail.passportNumber!=undefined)
          {
            if($scope.guest_detail.passportNumber.trim().length!=0)
            {
                ...
                $http({
                    url: 'http://192.168.1.10:8080/api/guest/passport/' + $scope.guest_detail.passportNumber + '/details',
                    method: 'get',
                    headers: {
                        'Authorization': localStorageService.get("auth")
                    }
    ...
    $scope.checkUniqueId = function ()
    {
         ...
         if($scope.guest_detail.idNumber!=undefined)
         {
            if($scope.guest_detail.idNumber.trim().length!=0)
            {
                ...
                $http({
                    url: 'http://192.168.1.10:8080/api/guest/uniqueid/' + $scope.guest_detail.idNumber + '/details',
                    method: 'get',
                    headers: {
                        'Authorization': localStorageService.get("auth")
                    }
...
manager_app.controller('add_guest_preference_controller', function ($scope, $http,ngDialog, $routeParams, localStorageService, $location,sharedPreferenceProperties) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/preference/types',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.addPreference = function () {
        ...
        $http({
            ...
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/preference/add',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
    ...
    $scope.onSelectPreferenceType = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/preference/' + $scope.guest_preference_type.id,
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
    ...
    $scope.deletePreference=function()
    {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/preference/delete' ,
            method: 'post',
            headers: {
                'Authorization': localStorageService.get("auth")
            },
...
manager_app.controller('update_preference_popup_controller', function ($scope, $http,ngDialog, $routeParams, localStorageService, $location,sharedPreferenceProperties) {
    ...
    {
        $http({
            url: 'http://192.168.1.10:8080/api/guest/preference/update',
            method: 'post',
            headers: {
                'Authorization': localStorageService.get("auth")
            },
...
manager_app.controller('view_guest_stay_details_controller', function ($scope, $http, $routeParams, localStorageService) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/gueststaydetails',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
...
manager_app.controller('add_stay_details_controller', function ($scope, $http, $routeParams, localStorageService, $location) {
    ...
    $scope.allFreeRooms=function()
    {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/hotel/' + $scope.current_user_hotel_id + '/rooms',
            method: 'post',
            headers: {
                'Authorization': localStorageService.get("auth")
            },
...
//get all available rooms when button is clicked
    ...
    $scope.add = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/addstaydetails',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
...
//before update we have to push and pop
    ...
    $scope.update = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/updatestaydetails',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
...
manager_app.controller('view_guest_room_card_controller', function ($scope, $http, $routeParams, localStorageService) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/roomcarddetails',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
...
manager_app.controller('maintain_room_key_cards_controller', function ($scope, $http, $routeParams, localStorageService, $location) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/roomkeycards',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.issueCard = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/cards/assign',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
    ...
    $scope.returnCard = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/' + $scope.current_card.id + '/returncard',
            method: 'get',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
    ...
    $scope.returnAllCards=function()
    {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/' + $routeParams.guestId + '/returncards',
            method: 'get',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
...
manager_app.controller('guest_contact_list_controller', function ($scope, localStorageService, $routeParams, $http) {
    ...
    <!-- get all contacts -->
    $http({
        url: 'http://192.168.1.10:8080/api/users/' + $scope.current_user_id + '/guest/contacts',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
...
manager_app.controller('view_manager_guest_contactlist_controller', function ($scope, localStorageService, $routeParams, $http) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/contacts/' + $routeParams.contactId,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
...
manager_app.controller('delete_guest_contact_list_controller', function ($scope, localStorageService, $routeParams, $http, $location) {
    ...
    $scope.delete = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/contacts/' + $routeParams.contactId + '/delete',
            method: 'put',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
...
manager_app.controller('current_guest_location_controller', function ($scope, $http, $location, localStorageService, $routeParams, $window) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/' + $scope.guest_id,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guests/' + $scope.guest_id + '/locations',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.showHistory = function () {
        $http({
            url: 'http://192.168.1.10:8080/api/guests/' + $scope.guest_id + '/location/history',
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
...
manager_app.controller('checkedin_guest_controller', function ($scope, $http, $location, localStorageService, $routeParams, $window) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/hotels/' + $scope.hotel_id + '/guests/checkedIn',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
...
manager_app.controller('touch_point_setup_list_controller', function ($scope, $http, $location, localStorageService, $routeParams, $window) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/touchpoint/' + $scope.current_touch_point_id + '/setups/current',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/tp/' + $routeParams.tpId + '/setups',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.setCurrentSetup = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/touchpoint/' + $scope.current_touch_point_id + '/setup/' + $scope.testModel,
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
...
manager_app.controller('touch_point_controller', function ($scope, localStorageService, $http) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/login/touchpoints',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
...
manager_app.controller('find_guest_controller', function ($scope, $http, $routeParams, $location, localStorageService,$route,$timeout) {
    console.log(' manager guest find controller is loaded');
    $scope.guest_list = [];

    $http({
        url: 'http://192.168.1.10:8080/api/touchpoints/' + $routeParams.TPId + '/guestCards',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
...
manager_app.controller('create_guest_contact_controller', function ($scope, localStorageService, $routeParams, $http, $location, ngDialog,$filter, ngTableParams) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guests',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.OnContactListNameChange=function()
    {
        console.log('checking for contact list name');
                    $http({
                        url: 'http://192.168.1.10:8080/api/manager/' +localStorageService.get("user").id + '/contact/'+$scope.guest_contact.name,
                        method: 'get',
                        headers: {
                            'Authorization': localStorageService.get("auth")
                        }
    ...
    $scope.create = function (create_contact_list_form) {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guest/contact/create',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
...
manager_app.controller('update_guest_contact_list_controller', function ($scope, localStorageService, $routeParams, $http, $location,ngDialog) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/contactguests/' + $routeParams.contactId,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/contacttp/' + $routeParams.contactId,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/notincontacts/' + $routeParams.contactId,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guest/notselecttp/' + $routeParams.contactId,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
             ...
             if($scope.name!=undefined)
              {
                ...
                {
                    $http({
                        url: 'http://192.168.1.10:8080/api/manager/' +localStorageService.get("user").id + '/contact/'+$scope.name,
                        method: 'get',
                        headers: {
                            'Authorization': localStorageService.get("auth")
                        }
    ...
    $scope.update = function (update_contact_list_app_form) {
       ...
       if ($scope.contactlist_validation_flag == false)
       {
        ...
        $http({
            // url: 'http://192.168.1.10:8080/api/guest/contact/create',
            url: 'http://192.168.1.10:8080/api/guest/contact/' + $routeParams.contactId + '/update',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
