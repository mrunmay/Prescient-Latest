...
admin_app.controller('list_users_controller', function ($scope, $http, $routeParams, localStorageService) {
    ...
    $scope.user = {};
    $http({
        url: 'http://192.168.1.10:8080/api/users',
        method: 'get',
        headers: {
    ...
    $scope.filterUserList=function()
    {
        ...
        {
            $http({
                url: 'http://192.168.1.10:8080/api/users/disabled',
                method: 'get',
                headers: {
                    'Authorization': localStorageService.get("auth")
                }
        ...
        {
            $http({
                url: 'http://192.168.1.10:8080/api/users/enabled',
                method: 'get',
                headers: {
                    'Authorization': localStorageService.get("auth")
                }
...
admin_app.controller('view_users_controller', function ($scope, $http, $routeParams, localStorageService) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/users/' + $scope.uId,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
...
admin_app.controller('update_users_controller', function ($scope, $http, $routeParams, $location, localStorageService) {
    ...
    <!-- get status -->
    $http({
        url: 'http://192.168.1.10:8080/api/status',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/roles',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/hotels/' + $scope.uId + '/dept/having',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/hotels/' + $scope.uId + '/dept/notHaving',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/users/' + $scope.uId + '/notAssignedTouchpoints',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.getTouchPointByDepartmentAndPush = function (departmentId) {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/departments/' + departmentId + '/touchpoints',
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
    ...
    $scope.update = function (user_update_form) {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/users/update/' + $scope.uId,
            method: 'put',
...
admin_app.controller('create_users_controller', function ($scope, $http, $location, localStorageService, ngDialog) {
    ...
    {
         $http({
            url: 'http://192.168.1.10:8080/api/username/'+$scope.user.userName,
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
    ...
    <!--Get Hotel-->
    $http({
        url: 'http://192.168.1.10:8080/api/hotels',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
    ...
    $scope.getDepartmentByHotelId = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/hotels/' + $scope.user.hotel.id + '/departments',
            method: 'get',
            headers: {
                'Authorization': localStorageService.get("auth")
            }
    ...
    $scope.getTouchPointsFromDepartments = function () {
        $scope.checked_touch_points = [];
        $http({
            url: 'http://192.168.1.10:8080/api/departments/touchpoints',
            method: 'post',
            headers: {
                'Authorization': localStorageService.get("auth")
            },
...
admin_app.controller('add_departments_controller', function ($scope, $http, $routeParams, $location, localStorageService) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/hotels/' + $routeParams.uId + '/dept/notHaving',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/hotels/' + $routeParams.uId + '/dept/having',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
    ...
    $scope.addDepartments = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/users/assignDept/' + $routeParams.uId,
            method: 'put',
            headers: {'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")},
...
admin_app.controller('delete_users_controller', function ($scope, $http, $routeParams, $location, localStorageService) {
    ...
    $scope.delete = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/users/' + $scope.uId + '/update/status/' + $scope.userStatus,
            method: 'get',
            headers: { 'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
            }
...
admin_app.controller('access_card_controller', function ($scope, $http, $routeParams, $location, localStorageService,$route,ngDialog) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/guestcards/all',
        method: 'get',
        headers: { 'Content-Type': 'application/json',
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.import = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guestcards',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
    ...
    $scope.checkCard = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guestcards/' + $scope.access_card_detail.magStripeNo + '/detail',
            method: 'get',
            headers: { 'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
            }
    ...
    $scope.save = function (magstripeno, rfidtagno) {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guestcards/' + $scope.card_detail.magStripeNo,
            method: 'put',
            headers: { 'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
            },
    ...
    $scope.filterCardList=function()
    {
        ...
        {
            $http({
                url: 'http://192.168.1.10:8080/api/guestcards/withRFID',
                method: 'get',
                headers: { 'Content-Type': 'application/json',
                    'Authorization': localStorageService.get("auth")
                }
        ...
        {
            $http({
                url: 'http://192.168.1.10:8080/api/guestcards/withoutRFID',
                method: 'get',
                headers: { 'Content-Type': 'application/json',
                    'Authorization': localStorageService.get("auth")
                }
    ...
    $scope.saveCard = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/guestcards/' + $scope.access_card_detail.magStripeNo,
            method: 'put',
            headers: { 'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
            },
...
admin_app.controller('touch_point_setup_controller', function ($scope, $http, $routeParams, $location, localStorageService) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/touchpoint/'+$scope.current_touch_point_id,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.setup = function (setup_form) {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/tp/setup',
            method: 'post',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
...
admin_app.controller('setup_view_controller', function ($scope, $http, $routeParams, $location, localStorageService) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/tpsetup/' + $routeParams.setupId,
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
...
admin_app.controller('delete_setup_controller', function ($scope, $http, $routeParams, $location, localStorageService) {
    ...
    $scope.delete = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/tpsetup/' + $routeParams.setupId + '/delete',
            method: 'delete',
            headers: { 'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
            }
...
admin_app.controller('reset_users_controller', function ($scope, $http, $routeParams, $location, localStorageService) {
    ...
    $scope.reset = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/users/' + $scope.uId + '/reset/password',
            method: 'get',
            headers: { 'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
            }
...
admin_app.controller('add_touch_points_controller', function ($scope, $http, $routeParams, $location, localStorageService) {
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/users/' + $routeParams.uId + '/tp/notHaving',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $http({
        url: 'http://192.168.1.10:8080/api/users/' + $routeParams.uId + '/tp/having',
        method: 'get',
        headers: {
            'Authorization': localStorageService.get("auth")
        }
    ...
    $scope.addTouchPoints = function () {
        ...
        $http({
            url: 'http://192.168.1.10:8080/api/users/assignTP/' + $routeParams.uId,
            method: 'put',
            headers: {'Content-Type': 'application/json',
                'Authorization': localStorageService.get("auth")
            },
